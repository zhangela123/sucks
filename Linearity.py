...
#plotting highschool rate for linearity
...
y = [99406, 83750, 82772, 72537, 93158, 59401, 99716, 55283, 93377, 53969, 89633, 48041, 97622, 57316, 53350, 57848, 47040, 56352, 68044, 57585, 115246, 48820, 51416, 53672, 45507, 62260, 71015, 88596, 66096, 90234, 89691, 55359, 67005, 67151, 86958, 63362, 78980, 112449, 64432, 73518, 122641, 74624, 124055, 82234, 54667, 52418, 45241, 81474, 81018, 60704, 59050, 44514, 40846, 49687, 60108, 88131, 70228, 58054]
plt.scatter(x, y, label= "stars", color= "green", marker= "*", s=30)
plt.xlabel('highschool')
plt.ylabel('afterinc')
plt.show()

#plotting bachelor rate for linearity
...
plt.scatter(x1, y, label= "stars", color= "green", marker= "*", s=30)
plt.xlabel('bachelor')
plt.ylabel('afterinc')
plt.show()

#plotting female rate for linearity
...
plt.scatter(x2, y, label= "stars", color= "green", marker= "*", s=30)
plt.xlabel('female')
plt.ylabel('afterinc')
plt.show()

# #plotting median income for linearity
...
plt.scatter(x3, y, label= "stars", color= "green", marker= "*", s=30)
plt.xlabel('medianinc')
plt.ylabel('afterinc')
plt.show()
